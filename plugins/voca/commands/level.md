...
- If `${CLAUDE_PLUGIN_DATA}/voca-profile.json` is missing OR every language has `spoken: false` → run **Setup Wizard** from `${CLAUDE_PLUGIN_ROOT}/skills/voca/SKILL.md`.
...
- Read `${CLAUDE_PLUGIN_ROOT}/skills/voca/SKILL.md` and execute the **Test Flow** section for the chosen language.
