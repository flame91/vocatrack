---
description: Inspect or edit vocab subsystem configuration (list columns, picker page size, scan model, …).
...
- Read `${CLAUDE_PLUGIN_ROOT}/skills/vocab/SKILL.md` and execute the **Config UI** section (Stage 1 picker → Stage 2 a/b/c/d branch).
